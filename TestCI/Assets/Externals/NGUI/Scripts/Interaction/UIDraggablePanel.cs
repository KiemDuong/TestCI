...
public class UIDraggablePanel : IgnoreTimeScale
{
	...
	public delegate void PanelDidScroll (Vector3 offset);
	
	public virtual void onAwakeFinish(){}
	...
	public virtual void PanelDidMoveRelative(Vector3 relative)
	{
